...
function isValid(firstName, surname, numberOfWorkingYears) {
    if (firstName.length == 0 || surname.length == 0 || numberOfWorkingYears.length == 0) {
        return false;
    }
    var n = parseInt(numberOfWorkingYears)
    if (isNaN(n) || n < 0) {
        return false;
    }
        return true;
...
function showWorkers() {
    var tableHtml = '<table class="table-striped";><tr><th>Name</th><th>Salary</th></tr>';
